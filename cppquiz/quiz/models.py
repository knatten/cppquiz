...
class Question(models.Model):
    ...
    explanation = models.TextField(default='', blank=True, help_text='Use markdown, and refer to the standard like this: \xc2\xa7x.y\xc2\xb6z.')
    hint = models.TextField(default='No hint', blank=True, help_text='Use markdown, and refer to the standard like this: \xc2\xa7x.y\xc2\xb6z.')
