...
class standard_ref_Test(unittest.TestCase):
    ...
    def test_given_name_references(self):
        ...
        self.assertEqual(u'<em><a href="https://timsong-cpp.github.io/cppwp/n4659/foo">[foo]\xa73.4</a></em>some_symbols', standard_ref(u'[foo]§3.4some_symbols'))
    ...
    def test_given_multiple_paragraphs(self):
        ...
        self.assertEqual(u'<em><a href="https://timsong-cpp.github.io/cppwp/n4659/foo.bar.baz#1">[foo.bar.baz]\xa73.4\xb61</a></em>, '
