...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.hint'
        db.add_column('quiz_question', 'hint',
                      self.gf('django.db.models.fields.TextField')(default='No hint', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.hint'
        db.delete_column('quiz_question', 'hint')
