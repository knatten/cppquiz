...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UsersAnswer.result'
        db.add_column('quiz_usersanswer', 'result', self.gf('django.db.models.fields.CharField')(default='OK', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UsersAnswer.result'
        db.delete_column('quiz_usersanswer', 'result')
