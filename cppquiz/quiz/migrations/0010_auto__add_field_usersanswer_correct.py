...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UsersAnswer.correct'
        db.add_column('quiz_usersanswer', 'correct', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UsersAnswer.correct'
        db.delete_column('quiz_usersanswer', 'correct')
