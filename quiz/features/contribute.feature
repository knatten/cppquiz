Feature: Contributing Questions
    Scenario: User contributes a valid question
        ...
        Then I fill in the spam protection correctly
    ...
    Scenario: User contributes a valid question, but fails spam protection
        When I visit /quiz/create
        Then I should see the contribute form
        Then I fill in the spam protection incorrectly
        Then I fill in "foo" as the question and "bar" as the explanation
        Then There is an error "You failed the spam protection" in spam_protection
